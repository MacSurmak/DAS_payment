...
LEXICON: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "admin_block_day": "🚫 Сделать день нерабочим",
        "admin_block_day_prompt": "Выберите дату, которую нужно сделать нерабочей:",
        "admin_block_day_select_window_prompt": "Для какого окна сделать <b>{date_to_block}</b> нерабочим?",
