...
LEXICON: dict[str, dict[str, str]] = {
    "ru": {
        ...
        # --- Registration Dialog ---
        "get_name_prompt": "📝 Для начала, пожалуйста, отправь свои Фамилию, Имя и Отчество (если есть), например:\n"
        ...
        "<b>{date} ({weekday}) в {time}</b> приходи в кабинет 137, окно №{window}. "
        ...
        "<b>Время:</b> {time}\n"
        "<b>Окно:</b> №{window}\n\n"
        "<tg-spoiler>Ты можешь отменить или перенести запись не позднее, чем за 3 часа до назначенного времени.</tg-spoiler>",
        ...
        # --- Notifications ---
        "notification_day_before": "Привет! Напоминаю, что ты записан(а) на получение документов в ДАС <b>завтра в {time}</b>.\nОкно №{window}.\n\n"
        "Не забудь все необходимые документы! Подробный список есть в сообщении, которое я прислал тебе после записи.",
        "notification_hour_before": "Привет! Напоминаю, что ты записан(а) на получение документов в ДАС уже <b>через час, в {time}</b>.\nОкно №{window}.\n\n"
        "Пора выходить! Не забудь документы.",
        # --- Throttling ---
