...
LEXICON: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "<b>{date} ({weekday}) в {time}</b> приходи в кабинет 137, окно №{window}. Для твоего удобства я отправил тебе схему этажа. "
        ...
        "5. Наличные деньги — 6400 рублей (желательно без сдачи)\n"
